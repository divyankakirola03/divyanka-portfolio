      ...
      <section className="px-5 pb-16 pt-10 sm:px-6 md:px-12 md:pb-24 md:pt-16 lg:px-16">
        <div className="mx-auto max-w-7xl">
          ...
          <div className="mt-10">
            ...
            <h1 className="mt-6 max-w-5xl font-serif text-[15vw] leading-[0.88] tracking-[-0.055em] sm:text-7xl md:text-8xl lg:text-[6.5rem]">
              Building
              <br />
              communities
              <br />
            ...
            <p className="mt-8 max-w-3xl text-base leading-relaxed text-black/55">
          ...
          <div className="mt-5 grid gap-5 md:grid-cols-2">
            ...
            <div className="group relative min-h-[380px] overflow-hidden rounded-[30px]">
              <Image
                ...
                alt="Leading a CyberZee technical learning session"
                fill
                className="object-cover transition duration-700 group-hover:scale-105"
                sizes="(max-width: 768px) 100vw, 50vw"
              />
